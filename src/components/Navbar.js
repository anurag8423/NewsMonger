...
export class Navbar extends Component {
  render() {
    return (
      <div>
        <nav className="navbar navbar-expand-lg bg-dark fixed-top py-1" data-bs-theme="dark">
          <div className="container-fluid">
            <Link className="navbar-brand nav_title"  to="/">NewsMonger</Link>
            <button className="navbar-toggler nav_buton" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
